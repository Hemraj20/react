...
const ApiData = () => {
  ...
  useEffect(() => {
    fetch(`${import.meta.env.VITE_API_URL}/product/get-product`)
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 py-12 px-8">
      ...
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold text-slate-800">Our Products</h1>
          ...
          >
            ...
            <div className="p-5">
              ...
              <div className="mt-3 flex justify-between text-sm">
                <span className="text-green-600">Stock: {prod.stock}</span>

                <span className="text-gray-500"> Brand: {prod.brand}</span>
              </div>
